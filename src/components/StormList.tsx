        ...
        return (
          <button
            ...
            className={`w-full rounded-[24px] border p-4 text-left transition duration-300 ${
              isActive
                ? 'border-cyan-300/45 bg-cyan-300/12 shadow-[0_10px_30px_rgba(34,211,238,0.16)]'
          ...
          >
            <div className="flex items-start justify-between gap-3">
              <div>
                <div className="flex items-center gap-2">
                  ...
                  <span className="rounded-full border border-white/10 bg-white/6 px-2 py-0.5 text-[10px] tracking-[0.22em] text-slate-300">
            ...
            <div className="mt-4 grid grid-cols-2 gap-3 text-sm text-slate-200">
              <div className="rounded-2xl bg-slate-950/30 p-3">
                <div className="text-xs text-slate-400">当前强度</div>
                <div className="mt-1 font-medium">{storm.intensity}</div>
              </div>
              <div className="rounded-2xl bg-slate-950/30 p-3">
                <div className="text-xs text-slate-400">最低气压</div>
